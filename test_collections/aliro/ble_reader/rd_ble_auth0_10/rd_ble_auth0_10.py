...
class RD_BLE_AUTH0_10(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-BLE-AUTH0-1.0",
        "version": "0.0.1",
        "title": "RD-BLE-AUTH0-1.0",
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep("Step4: Verify vendor extension support"),
        ]
    ...
    async def cleanup(self) -> None:
        logger.info("RD_BLE_AUTH0_10 Cleanup")
        try:
