...
class BLEUWB_RDR_NEG_TIMEOUT_BEFORE_AUTH0(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "BLEUWB_RDR_NEG_TIMEOUT_BEFORE_AUTH0",
        "version": "0.0.1",
        "title": "BLEUWB_RDR_NEG_TIMEOUT_BEFORE_AUTH0",
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep("Step4: Wait for atleast 3 seconds"),
            TestStep("Step5: User device sends general error"),
        ]
    ...
    async def execute(self) -> None:
        ...
        self.next_step()
        # Test step 4: Wait for atleast 3 seconds
        time.sleep(3)

        self.next_step()
        # Test step 5: Reader sends general error
        try:
