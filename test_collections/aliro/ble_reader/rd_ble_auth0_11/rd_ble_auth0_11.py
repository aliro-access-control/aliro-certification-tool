...
class RD_BLE_AUTH0_11(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-BLE-AUTH0-1.1",
        "version": "0.0.1",
        "title": "RD-BLE-AUTH0-1.1",
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep("Step11: Conditional: Device sends AP_RS message: GET RESPONSE"),
            ...
            TestStep("Step16: Verify vendor extension support")
        ]
    ...
    async def cleanup(self) -> None:
        logger.info("RD_BLE_AUTH0_11 Cleanup")
        try:
            await self.userdevice.transaction_termination()
