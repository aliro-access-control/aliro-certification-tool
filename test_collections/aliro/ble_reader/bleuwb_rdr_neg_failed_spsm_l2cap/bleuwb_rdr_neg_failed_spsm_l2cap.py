...
class BLEUWB_RDR_NEG_FAILED_SPSM_L2CAP(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "BLEUWB_RDR_NEG_FAILED_SPSM_L2CAP",
        "version": "0.0.1",
        "title": "BLEUWB_RDR_NEG_FAILED_SPSM_L2CAP",
    ...
    async def cleanup(self) -> None:
        logger.info("BLEUWB_RDR_NEG_FAILED_SPSM_L2CAP Cleanup")
        try:
