...
class BLERKE_RDR_UNSECURE(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "BLERKE_RDR_UNSECURE",
        "version": "0.0.1",
        "title": "BLERKE_RDR_UNSECURE",
    ...
    async def execute(self) -> None:
        ...
        try:
            ...
            if self.userdevice.reader_status_information != ReaderStatusInformation_Values.UNSECURED:
    ...
    async def cleanup(self) -> None:
        logger.info("BLERKE_RDR_UNSECURE Cleanup")
        try:
