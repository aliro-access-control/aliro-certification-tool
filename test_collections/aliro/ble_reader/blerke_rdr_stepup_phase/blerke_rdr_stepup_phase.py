...
class BLERKE_RDR_STEPUP_PHASE(AliroReaderTestCase, UserPromptSupport):
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep("Step5: Device sends RKE request message"),
            TestStep("Step6: Reader sends Reader Status Changed message"),
        ]
    ...
    async def execute(self) -> None:
       ...
       # Test step 4 - Reader sends AP message: AP completed
        try:
            ...
            return
        self.next_step()
        # Test step 5 Reader sends Reader Status Changed message
        try:
        ...
        # Test step 6 - Device sends RKE request message
        try:
    ...
    async def cleanup(self) -> None:
        logger.info("BLERKE_RDR_STEPUP_PHASE Cleanup")
        try:
