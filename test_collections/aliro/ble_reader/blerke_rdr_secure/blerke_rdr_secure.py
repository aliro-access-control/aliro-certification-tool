...
class BLERKE_RDR_SECURE(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "BLERKE_RDR_SECURE",
        "version": "0.0.1",
        "title": "BLERKE_RDR_SECURE",
    ...
    async def execute(self) -> None:
        ...
        try:
            ...
            if status_changed.reader_status_information not in [ReaderStatusInformation_Values.SECURED,
                                                                ReaderStatusInformation_Values.JAMMED,
                                                                ReaderStatusInformation_Values.STARTED_SECURE,
    ...
    async def cleanup(self) -> None:
        logger.info("BLERKE_RDR_SECURE Cleanup")
        try:
