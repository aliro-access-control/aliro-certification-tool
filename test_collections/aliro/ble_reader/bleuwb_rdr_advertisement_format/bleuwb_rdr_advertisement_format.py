...
class BLEUWB_RDR_ADVERTISEMENT_FORMAT(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "BLEUWB_RDR_ADVERTISEMENT_FORMAT",
        "version": "0.0.1",
        "title": "BLEUWB_RDR_ADVERTISEMENT_FORMAT",
    ...
    async def cleanup(self) -> None:
        logger.info("BLEUWB_RDR_ADVERTISEMENT_FORMAT Cleanup")
        try:
