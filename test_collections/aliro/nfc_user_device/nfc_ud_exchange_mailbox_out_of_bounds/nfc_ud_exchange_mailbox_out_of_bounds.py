...
class NFC_UD_EXCHANGE_MAILBOX_OUT_OF_BOUNDS(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_UD_EXCHANGE_MAILBOX_OUT_OF_BOUNDS",
        "version": "0.0.1",
        "title": "NFC_UD_EXCHANGE_MAILBOX_OUT_OF_BOUNDS",
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_UD_EXCHANGE_MAILBOX_OUT_OF_BOUNDS Cleanup")
