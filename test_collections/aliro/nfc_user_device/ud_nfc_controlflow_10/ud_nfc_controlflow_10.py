...
class UD_NFC_CONTROLFLOW_10(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-NFC-CONTROLFLOW-1.0",
        "version": "0.0.1",
        "title": "UD-NFC-CONTROLFLOW-1.0",
    ...
    async def setup(self) -> None:
        logger.info("UD_NFC_CONTROLFLOW_10 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("UD_NFC_CONTROLFLOW_10 Cleanup")
