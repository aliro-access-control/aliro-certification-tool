...
class NFC_UD_NEG_AUTH1_WRONG_P1P2(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_UD_NEG_AUTH1_WRONG_P1P2",
        "version": "0.0.1",
        "title": "NFC_UD_NEG_AUTH1_WRONG_P1P2",
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_UD_NEG_AUTH1_WRONG_P1P2 Cleanup")
