...
class NFC_UD_NEG_AUTH1_EXTRA_TAG(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_UD_NEG_AUTH1_EXTRA_TAG",
        "version": "0.0.1",
        "title": "NFC_UD_NEG_AUTH1_EXTRA_TAG",
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_UD_NEG_AUTH1_EXTRA_TAG Cleanup")
