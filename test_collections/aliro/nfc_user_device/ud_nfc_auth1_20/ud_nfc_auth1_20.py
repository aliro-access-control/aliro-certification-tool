...
class UD_NFC_AUTH1_20(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-NFC-AUTH1-2.0",
        "version": "0.0.1",
        "title": "UD-NFC-AUTH1-2.0",
    ...
    async def setup(self) -> None:
        logger.info("UD_NFC_AUTH1_20 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("UD_NFC_AUTH1_20 Cleanup")
