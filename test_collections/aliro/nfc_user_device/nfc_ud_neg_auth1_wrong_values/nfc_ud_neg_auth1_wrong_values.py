...
class NFC_UD_NEG_AUTH1_WRONG_VALUES(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_UD_NEG_AUTH1_WRONG_VALUES",
        "version": "0.0.1",
        "title": "NFC_UD_NEG_AUTH1_WRONG_VALUES",
    ...
    async def execute(self) -> None:
        ...
        try:
            ...
            data_fields: list[tuple[int, bytes | list]] = [
                ...
                (Auth1.READER_SIG_TAG, reader_sig + bytes([0xFF])),
            ]
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_UD_NEG_AUTH1_WRONG_VALUES Cleanup")
