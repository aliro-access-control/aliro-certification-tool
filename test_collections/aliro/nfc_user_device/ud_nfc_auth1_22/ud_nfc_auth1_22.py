...
class UD_NFC_AUTH1_22(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-NFC-AUTH1-2.2",
        "version": "0.0.1",
        "title": "UD-NFC-AUTH1-2.2",
    ...
    async def setup(self) -> None:
        logger.info("UD_NFC_AUTH1_22 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("UD_NFC_AUTH1_22 Cleanup")
