...
class UD_NFC_STDTXN_21(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-NFC-STDTXN-2.1",
        "version": "0.0.1",
        "title": "UD-NFC-STDTXN-2.1",
        "description": """Verify conformance of User Device UT in AUTH1 command, using keyslot""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("UD_NFC_STDTXN_21 Cleanup")
