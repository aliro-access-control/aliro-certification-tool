...
class UD_NFC_AUTH0_30(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-NFC-AUTH0-3.0",
        "version": "0.0.1",
        "title": "UD-NFC-AUTH0-3.0",
    ...
    async def setup(self) -> None:
        logger.info("UD_NFC_AUTH0_30 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("UD_NFC_AUTH0_30 Cleanup")
