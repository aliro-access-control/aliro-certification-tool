...
class NFC_UD_NEG_AUTH0_UNSUPPORTED_PROTOCOL_VERSION(AliroUserDeviceTestCase, UserPromptSupport):
    ...
    UNSUPPORTED_PROTOCOL_VERSION = 0x0400 #Supported protocol version 0x0100 is changed to 0x0400
    ...
    async def setup(self) -> None:
        ...
        self.reader._protocol_version = self.UNSUPPORTED_PROTOCOL_VERSION
