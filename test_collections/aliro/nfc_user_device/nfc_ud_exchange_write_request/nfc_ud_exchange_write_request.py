...
class NFC_UD_EXCHANGE_WRITE_REQUEST(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_UD_EXCHANGE_WRITE_REQUEST",
        "version": "0.0.1",
        "title": "NFC_UD_EXCHANGE_WRITE_REQUEST",
        "description": """Expedited Phase With EXCHANGE command sending multiple WRITE requests multiple times.""",
    }
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep("Step6: Send EXCHANGE command multiple times with multiple WRITE requests with atomic session = TRUE and Receive EXCHANGE response"),
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_UD_EXCHANGE_WRITE_REQUEST Cleanup")
