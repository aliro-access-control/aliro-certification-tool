...
class NFC_UD_STEPUP_RD(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_UD_STEPUP_RD",
        "version": "0.0.1",
        "title": "NFC_UD_STEPUP_RD",
    ...
    async def execute(self) -> None:
        ...
        for document in device_response.documents:
            if document.doc_type != DocTypes.ALIRO_REVOCATION:
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_UD_STEPUP_RD Cleanup")
