...
class UD_BLE_AUTH1_31(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-BLE-AUTH1-3.1",
        "version": "0.0.1",
        "title": "UD-BLE-AUTH1-3.1",
    ...
    async def setup(self) -> None:
        logger.info("UD_BLE_AUTH1_31 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("UD_BLE_AUTH1_31 Cleanup")
