...
class BLEUWB_UD_NEG_SUSPEND_MISMATCH_PARAMETER(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "BLEUWB_UD_NEG_SUSPEND_MISMATCH_PARAMETER",
        "version": "0.0.1",
        "title": "BLEUWB_UD_NEG_SUSPEND_MISMATCH_PARAMETER",
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep("Step8: Reader sends Ranging Session Suspend Request with incorrect session ID"),
            TestStep("Step9: User device sends general error wrong parameters"),
        ]
    ...
    async def execute(self) -> None:
        ...
        self.next_step()
        # Step9: User Device sends event General error wrong parameters
        try:
