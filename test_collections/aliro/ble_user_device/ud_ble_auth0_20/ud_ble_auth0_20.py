...
class UD_BLE_AUTH0_20(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-BLE-AUTH0-2.0",
        "version": "0.0.1",
        "title": "UD-BLE-AUTH0-2.0",
    ...
    async def setup(self) -> None:
        logger.info("UD_BLE_AUTH0_20 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("UD_BLE_AUTH0_20 Cleanup")
