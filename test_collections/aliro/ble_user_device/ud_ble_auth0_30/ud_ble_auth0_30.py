...
class UD_BLE_AUTH0_30(AliroUserDeviceTestCase, UserPromptSupport):
    metadata = {
        "public_id": "UD-BLE-AUTH0-3.0",
        "version": "0.0.1",
        "title": "UD-BLE-AUTH0-3.0",
    ...
    async def setup(self) -> None:
        logger.info("UD_BLE_AUTH0_30 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("UD_BLE_AUTH0_30 Cleanup")
