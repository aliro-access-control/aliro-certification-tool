...
class AliroReaderTestCase(AliroTestCase):
    ...
    def default_test_parameters(self) -> dict[str, Any]:
        ...
        return {
            ...
            self.READER_ISSUER_PUBLIC_KEY_KEY: "0485e2c28f05fc09597190b520a1b966041cdd8"
            "8c8bd519847d46bccea8b26ddb820f878a904e8482ff130b0c7deb9b80c2132a497913de29"
            "c3962228a7e99118e",
        }
...
class AliroUserDeviceTestCase(AliroTestCase):
    ...
    def default_test_parameters(self) -> dict[str, Any]:
        ...
        return {
            ...
            self.READER_GROUP_ID_KEY: "00113344667799AA00113344667799AA",
            self.READER_SUB_GROUP_ID_KEY: "113344667799AA00113344667799AA00",
            self.READER_CERTIFICATE_KEY: "308201533081f9a003020102020101300a06082a8648c"
            ...
            "428c00cd834998c5d0eab192ee8873c5d34eea341303f301f0603551d230418301680145b0"
            "59d140404f8bf5cca0c04b96f5d0c2b8b015d300c0603551d130101ff04023000300e06035"
            "51d0f0101ff040403020780300a06082a8648ce3d040302034900304602210089a4bd5d2c7"
            "84074916e5dc080486cea562c0796e240d634b40a41ecc0da9e7f022100f57af263733eaf7"
            "4d53a1224dcd9039c79af2638e9f2cd6395070f1445c1174f",
            self.READER_GROUP_RESOLVING_KEY: "00000000000000000000000000000000",
