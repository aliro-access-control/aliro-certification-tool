...
class NFC_RDR_NEG_STEPUP_AD_INVALID_ACCESS_DATA_ELEMENT_VERSION(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_INVALID_ACCESS_DATA_ELEMENT_VERSION",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_INVALID_ACCESS_DATA_ELEMENT_VERSION",
        "description": """Verify rejection of Access Document with incorrect Access Data Element version""",
    }
    ...
    def build_access_document(self, access_credential_pk: bytes) -> bytes:
        ...
        access_element.version = 42  # Make invalid
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_INVALID_ACCESS_DATA_ELEMENT_VERSION Cleanup")
