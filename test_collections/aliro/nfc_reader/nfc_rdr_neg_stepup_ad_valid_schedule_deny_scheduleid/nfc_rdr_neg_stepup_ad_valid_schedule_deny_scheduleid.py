...
from aliro_actuator.access_document.aliro.access import AccessData, AccessRule, Schedule,\
...
class NFC_RDR_NEG_STEPUP_AD_VALID_SCHEDULE_DENY_SCHEDULEID(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_VALID_SCHEDULE_DENY_SCHEDULEID",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_VALID_SCHEDULE_DENY_SCHEDULEID",
        "description": """Verify rejection of Access Document with a valid deny schedule""",
    }
    ...
    def build_access_document(self, access_credential_pk: bytes) -> bytes:
        ...
        access_rule.deny_schedule_ids.append(AccessRuleScheduleIds.SCHEDULE_1)  # Make invalid
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_VALID_SCHEDULE_DENY_SCHEDULEID Cleanup")
