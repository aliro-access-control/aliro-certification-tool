...
class NFC_RDR_NEG_STEPUP_AD_NO_DATA_ELEMENTS(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_NO_DATA_ELEMENTS",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_NO_DATA_ELEMENTS",
        "description": """Verify rejection of Access Document with no data elements""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_NO_DATA_ELEMENTS Cleanup")
