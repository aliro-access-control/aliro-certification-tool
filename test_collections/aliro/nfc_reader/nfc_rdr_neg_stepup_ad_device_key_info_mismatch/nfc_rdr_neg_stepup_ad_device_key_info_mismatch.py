...
from aliro_actuator.access_document.aliro.access import AccessData
...
class NFC_RDR_NEG_STEPUP_AD_DEVICE_KEY_INFO_MISMATCH(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_DEVICE_KEY_INFO_MISMATCH",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_DEVICE_KEY_INFO_MISMATCH",
        "description": """Verify rejection of Access Document not associated with the Access Credential""",
    }
    ...
    invalid_PubK = bytes.fromhex("0400ADBB74BBBB7E06B0A28C7D049B023796CD0F7CB9E279EC42ECFE6E415842451EB93AC5BF62D25CC"
                                 "1DAEA898A82B18BD813A061E21CB58B3CA93DA6DC7EC300")
    ...
    def build_access_document(self, access_credential_pk: bytes) -> bytes:
        ...
        x = DeviceResponseBuilder.build_doc(
            ...
            device_public_key=self.invalid_PubK,  # Make invalid
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_DEVICE_KEY_INFO_MISMATCH Cleanup")
