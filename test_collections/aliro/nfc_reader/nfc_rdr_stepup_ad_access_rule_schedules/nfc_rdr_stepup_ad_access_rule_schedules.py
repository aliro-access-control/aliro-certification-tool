...
class NFC_RDR_STEPUP_AD_ACCESS_RULE_SCHEDULES(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_STEPUP_AD_ACCESS_RULE_SCHEDULES",
        "version": "0.0.1",
        "title": "NFC_RDR_STEPUP_AD_ACCESS_RULE_SCHEDULES",
        "description": """Verify parsing of Access Document with Access Rule with schedules""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_STEPUP_AD_ACCESS_RULE_SCHEDULES Cleanup")
