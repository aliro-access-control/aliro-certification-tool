...
class NFC_RDR_NEG_STEPUP_AD_NO_ISSUER_CERT_NO_KEY_ID(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_NO_ISSUER_CERT_NO_KEY_ID",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_NO_ISSUER_CERT_NO_KEY_ID",
        "description": """Verify rejection of Access Document with no Issuer Certificate or Key Identifier""",
    }
    ...
    def build_access_document(self, access_credential_pk: bytes) -> bytes:
        ...
        x.issuer_signed.issuer_auth.key_id = None  # Make invalid
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_NO_ISSUER_CERT_NO_KEY_ID Cleanup")
