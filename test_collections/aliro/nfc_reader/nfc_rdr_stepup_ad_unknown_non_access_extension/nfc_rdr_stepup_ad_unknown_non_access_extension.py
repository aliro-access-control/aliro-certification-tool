...
from aliro_actuator.access_document.aliro.access import AccessData, NonAccessExtension
from aliro_actuator.access_document.aliro.common import ExtensionData
...
class NFC_RDR_STEPUP_AD_UNKNOWN_NON_ACCESS_EXTENSION(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_STEPUP_AD_UNKNOWN_NON_ACCESS_EXTENSION",
        "version": "0.0.1",
        "title": "NFC_RDR_STEPUP_AD_UNKNOWN_NON_ACCESS_EXTENSION",
        "description": """Verify parsing of Access Document with Unknown Non-access Extension""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_STEPUP_AD_UNKNOWN_NON_ACCESS_EXTENSION Cleanup")
