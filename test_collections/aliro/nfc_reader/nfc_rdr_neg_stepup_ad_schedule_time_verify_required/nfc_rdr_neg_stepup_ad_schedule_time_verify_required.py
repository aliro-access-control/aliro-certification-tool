...
from aliro_actuator.access_document.utility import Utility
...
from aliro_actuator.access_document.aliro.access import AccessData, AccessRule, AccessRuleCapabilitiesBits,\
    AccessRuleScheduleIds, Schedule, ScheduleFlagBits, RecurrenceRulePatternType
...
class NFC_RDR_NEG_STEPUP_AD_SCHEDULE_TIME_VERIFY_REQUIRED(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_SCHEDULE_TIME_VERIFY_REQUIRED",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_SCHEDULE_TIME_VERIFY_REQUIRED",
        "description": """Verify rejection of Access Document with schedules requiring time verification""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_SCHEDULE_TIME_VERIFY_REQUIRED Cleanup")
