...
class RD_NFC_CONTROLFLOW_20(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-NFC-CONTROLFLOW-2.0",
        "version": "0.0.1",
        "title": "RD-NFC-CONTROLFLOW-2.0",
    ...
    async def setup(self) -> None:
        logger.info("RD_NFC_CONTROLFLOW_20 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("RD_NFC_CONTROLFLOW_20 Cleanup")
