...
from aliro_actuator.access_document.mdl.common import DocTypes, IssuerNamespaces
...
class NFC_RDR_NEG_STEPUP_AD_INVALID_HASH_ISSUER_AUTH(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_INVALID_HASH_ISSUER_AUTH",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_INVALID_HASH_ISSUER_AUTH",
        "description": """Verify rejection of Access Document with an invalid Data Element digest""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_INVALID_HASH_ISSUER_AUTH Cleanup")
