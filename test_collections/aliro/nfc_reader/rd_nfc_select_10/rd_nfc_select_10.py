...
class RD_NFC_SELECT_10(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-NFC-SELECT-1.0",
        "version": "0.0.1",
        "title": "RD-NFC-SELECT-1.0",
    ...
    async def setup(self) -> None:
        logger.info("RD_NFC_SELECT_10 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("RD_NFC_SELECT_10 Cleanup")
