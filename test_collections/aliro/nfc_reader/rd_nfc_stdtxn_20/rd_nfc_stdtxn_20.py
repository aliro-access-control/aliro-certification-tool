...
class RD_NFC_STDTXN_20(AliroReaderTestCase, UserPromptSupport):
    ...
    async def execute(self) -> None:
        ...
        # Test step 6
        userdevice.response_auth1(
            # TODO: API does not support endpoint_epubk in response_auth1.
            endpoint_epubk=self.endpoint_ePuBK,
            signaling_bitmap=0,
            reader_epubk=0,  # This all comes from the auth0 command?
            reader_identifier=0,
