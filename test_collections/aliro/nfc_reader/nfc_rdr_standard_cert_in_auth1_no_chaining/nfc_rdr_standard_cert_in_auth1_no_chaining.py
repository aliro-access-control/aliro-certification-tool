...
class NFC_RDR_STANDARD_CERT_IN_AUTH1_NO_CHAINING(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_STANDARD_CERT_IN_AUTH1_NO_CHAINING",
        "version": "0.0.1",
        "title": "NFC_RDR_STANDARD_CERT_IN_AUTH1_NO_CHAINING",
    ...
    async def execute(self) -> None:
        ...
        try:
            ...
            self.mark_step_failure(str(error))
            return
        if hasattr(self.userdevice.session, "cert") and self.userdevice.chaining_command == True:
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_STANDARD_CERT_IN_AUTH1_NO_CHAINING Cleanup")
