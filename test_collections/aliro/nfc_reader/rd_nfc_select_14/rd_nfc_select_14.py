...
class RD_NFC_SELECT_14(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-NFC-SELECT-1.4",
        "version": "0.0.1",
        "title": "RD-NFC-SELECT-1.4",
        "description": """Verify conformance of Reader UT in SELECT command with no supported versions.""",
    }
    ...
    async def setup(self) -> None:
        logger.info("RD_NFC_SELECT_14 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("RD_NFC_SELECT_14 Cleanup")
