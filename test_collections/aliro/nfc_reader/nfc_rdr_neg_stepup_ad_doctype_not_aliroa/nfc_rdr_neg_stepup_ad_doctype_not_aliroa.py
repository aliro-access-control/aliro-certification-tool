...
class NFC_RDR_NEG_STEPUP_AD_DOCTYPE_NOT_ALIROA(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_DOCTYPE_NOT_ALIROA",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_DOCTYPE_NOT_ALIROA",
        "description": """Verify rejection of Access Document with invalid docType""",
    }
    ...
    def build_access_document(self, access_credential_pk: bytes) -> bytes:
        ...
        x.doc_type = "bad-doctype"  # Make invalid
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_DOCTYPE_NOT_ALIROA Cleanup")
