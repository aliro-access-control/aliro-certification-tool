...
class RD_NFC_AUTH0_10(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-NFC-AUTH0-1.0",
        "version": "0.0.1",
        "title": "RD-NFC-AUTH0-1.0",
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep("Step5: Verify vendor extension support")
        ]
    ...
    async def execute(self) -> None:
        ...
        # Test step 5: Verify vendor extension support 
    ...
    async def cleanup(self) -> None:
        logger.info("RD_NFC_AUTH0_10 Cleanup")
