...
class RD_NFC_EXCHANGE_20(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-NFC-EXCHANGE-2.0",
        "version": "0.0.1",
        "title": "RD-NFC-EXCHANGE-2.0",
    ...
    async def setup(self) -> None:
        logger.info("RD_NFC_EXCHANGE_2.0 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("RD_NFC_EXCHANGE_2.0 Cleanup")
