...
class NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_INVALID_SIGNATURE(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_INVALID_SIGNATURE",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_INVALID_SIGNATURE",
        "description": """Verify rejection of Access Document with invalid Issuer Cert""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_INVALID_SIGNATURE Cleanup")
