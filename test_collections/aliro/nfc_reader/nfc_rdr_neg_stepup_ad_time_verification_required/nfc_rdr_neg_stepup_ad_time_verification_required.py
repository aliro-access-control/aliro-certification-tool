...
class NFC_RDR_NEG_STEPUP_AD_TIME_VERIFICATION_REQUIRED(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_TIME_VERIFICATION_REQUIRED",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_TIME_VERIFICATION_REQUIRED",
        "description": """Verify rejection of Access Document requiring time verification""",
    }
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_TIME_VERIFICATION_REQUIRED Cleanup")
