...
class RD_NFC_EXCHANGE_11(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-NFC-EXCHANGE-1.1",
        "version": "0.0.1",
        "title": "RD-NFC-EXCHANGE-1.1",
    ...
    async def setup(self) -> None:
        logger.info("RD_NFC_EXCHANGE_1.1 setup")
    ...
    async def execute(self) -> None:
        ...
        try:
            ...
            await self.userdevice.response_auth1(
                key_slot=self.userdevice.session.access_credential.get_key_slot(),
                None,
    ...
    async def cleanup(self) -> None:
        logger.info("RD_NFC_EXCHANGE_1.1 Cleanup")
