...
class NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_EXPIRED(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_EXPIRED",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_EXPIRED",
        "description": """Verify rejection of Access Document with expired Issuer Cert""",
    }
    ...
    def build_access_document(self, access_credential_pk: bytes) -> bytes:
        ...
        x509 = Certificate.generate(
            ...
            validity_not_after=bytes.fromhex("3230303130313031303030305A"),  # Make Invalid, expired on Jan-1-2020@1AM
        )
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_STEPUP_AD_ISSUER_CERT_EXPIRED Cleanup")
