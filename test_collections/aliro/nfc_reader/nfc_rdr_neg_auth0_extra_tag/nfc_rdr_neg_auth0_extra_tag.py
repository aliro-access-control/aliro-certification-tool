...
class NFC_RDR_NEG_AUTH0_EXTRA_TAG(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_AUTH0_EXTRA_TAG",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_AUTH0_EXTRA_TAG",
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_AUTH0_EXTRA_TAG Cleanup")
