...
class NFC_RDR_NEG_AUTH1_WRONG_UD_SIGNATURE(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_NEG_AUTH1_WRONG_UD_SIGNATURE",
        "version": "0.0.1",
        "title": "NFC_RDR_NEG_AUTH1_WRONG_UD_SIGNATURE",
    ...
    async def execute(self) -> None:
        ...
        try:
            ...
            signature = signature[:-3] + bytes([0xFF, 0xFF, 0xFF])
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_NEG_AUTH1_WRONG_UD_SIGNATURE Cleanup")
