...
class NFC_RDR_STANDARD_CERT_IN_AUTH1_WITH_CHAINING(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "NFC_RDR_STANDARD_CERT_IN_AUTH1_WITH_CHAINING",
        "version": "0.0.1",
        "title": "NFC_RDR_STANDARD_CERT_IN_AUTH1_WITH_CHAINING",
    ...
    async def cleanup(self) -> None:
        logger.info("NFC_RDR_STANDARD_CERT_IN_AUTH1_WITH_CHAINING Cleanup")
