...
class RD_NFC_EXCHANGE_14(AliroReaderTestCase, UserPromptSupport):
    metadata = {
        "public_id": "RD-NFC-EXCHANGE-1.4",
        "version": "0.0.1",
        "title": "RD-NFC-EXCHANGE-1.4",
    ...
    async def setup(self) -> None:
        logger.info("RD_NFC_EXCHANGE_1.4 setup")
    ...
    async def cleanup(self) -> None:
        logger.info("RD_NFC_EXCHANGE_1.4 Cleanup")
